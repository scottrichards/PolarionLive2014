...
<div data-role="header">
		<h2><a href="../index.html"><img class="polarion-logo" src="../_img/polarion_logo_240x264.gif" width="62" height="67" alt="Polarion" /></a><span class="heading">Rate Session</span></h2>
</div><!-- /header -->
<div class="centered">
<?php
	...
	$rating= new ParseObject("SessionRating");
	$rating->set("sessionId",$_POST['session']);
	$rating->set("contentRating",intval($_POST['contentRating']));
	$rating->set("presenterRating",intval($_POST['presenterRating']));
	try {
		$rating->save();
		echo '<br />Thank you for submitting Rating!<br />';
